...
if (isset($_POST['id'])) {
	...
	$stmt->execute(['id' => $id]);
	$slno = 1;
	$fee_view = "<table border='1' style='width: 100%;'><tr ><th style='padding: 10px;'>SLNO</th><th style='padding: 10px;'>ID</th><th style='padding: 10px;'>TYPE</th><th style='padding: 10px;'>PAID</th><th style='padding: 10px;'>DATE AND TIME</th><th style='padding: 10px;'>BY</th></tr>";
	foreach ($stmt as $row) {
		$fee_view .= "
		<tr>
		...
		<td style='padding: 5px;'>".$row['payments_created_date']."</td>
